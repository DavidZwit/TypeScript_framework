class TestClass extends Seed {
    constructor() {
        ...
        GameObject.Instantiate(this.theLight, new Transform(this.theLight));
        //this.theLight.pencile.drawName = true;
        this.otherLight = new Light("otherLight", 200);
        GameObject.Instantiate(this.otherLight, new Transform(this.otherLight, new Vector2(150, 150)));
        ...
        this.Update = () => {
            ...
            let speed = .2;
            let xSpeed = new Vector2((Input.getKeyDown(KeyCode.A) == true ? -speed : 0) + (Input.getKeyDown(KeyCode.D) == true ? speed : 0), (Input.getKeyDown(KeyCode.W) == true ? -speed : 0) + (Input.getKeyDown(KeyCode.S) == true ? speed : 0));
